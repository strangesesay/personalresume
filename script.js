document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.stat-circle, .language-circle, .skill-level, .timeline-item, .experience-card, .activity-card, .certificate-card, .project-card').forEach(el => {
        observer.observe(el);
    });
